...
router.get('/', function (req, res, next) {
    ...
    categoriaModel.findAll().then(function (categorias) {
...
router.get('/:ca_categoria', function (req, res, next) {
    ...
    categoriaModel.findByPk(categoriaId).then(function (categoria) {
        // Respuesta		
        let respuesta = {}
...
router.post('/', function (req, res, next) {
    ...
    categoriaModel.create(categoriaRegister).then(categoria => {
        let resCreated = {
...
router.put('/:us_categoria', function (req, res, next) {
    ...
    if (categoriaId !== undefined && categoriaId !== null) {
        categoriaModel.update(categoriaRegister, {
            where: {
